...
{{-- Wishlist dropdown panel — rendered outside navbar to avoid stacking context issues --}}
<div x-data>
    {{-- Wishlist backdrop --}}
    <div
    ...
    <section
        ...
        class="fixed right-4 top-14 z-[70] w-80 sm:w-96 max-h-[70vh] rounded-2xl
    ...
    >
        ...
        <div class="overflow-y-auto gold-scroll flex-1">
            ...
            <div x-show="$store.wishlist.loading" class="flex items-center justify-center py-8">
                <svg class="animate-spin h-5 h-5 text-amber-400" fill="none" viewBox="0 0 24 24">
